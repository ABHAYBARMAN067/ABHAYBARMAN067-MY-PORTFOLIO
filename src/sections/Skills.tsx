...
//       { name: 'CSS', level: 90, icon: SiCss, color: '#1572B6' }, // <-- Fixed here
...
//       { name: 'Framer Motion', level: 75, icon: SiFramer, color: '#E11D48' },
//       { name: 'WordPress', level: 70, icon: SiWordpress, color: '#21759B' },
//     ],
//   },
//   {
//     category: 'Backend & DB',
...
//       { name: 'SQL / MySQL', level: 75, icon: SiMysql, color: '#4479A1' },
//       { name: 'Cloudinary', level: 80, icon: SiCloudinary, color: '#3448C5' },
//     ],
//   },
//   {
//     category: 'DevOps & Tools',
//     skills: [
//       { name: 'Git', level: 85, icon: SiGit, color: '#F1502F' },
...
//       { name: 'CI/CD Pipelines', level: 70, icon: SiGithubactions, color: '#2088FF' },
//     ],
//   },
// ];
...
//   'Backend & DB': 'Creating scalable APIs, managing NoSQL/SQL databases, and server-side logic using Node.js.',
//   'DevOps & Tools': 'Deploying applications on AWS/Vercel, containerization with Docker, CI/CD pipelines, and version control.',
// };
// const mainTechStack = [
...
//   { name: 'Framer Motion', icon: SiFramer, color: '#E11D48' },
...
//                   {/* Back */}
//                   <div className="absolute inset-0 glass rounded-2xl p-8 rotate-y-180 backface-hidden overflow-y-auto custom-scrollbar">
//                     <SkillBars
//                       category={category}
//                       skills={skills}
//                       groupIndex={gi}
...
//               }
//             }
//             /* Back card internal scroll hiding */
